...
data33<-read.csv("C:/Users/98001/Desktop/R/data-group1.csv",encoding="UTF-8")
...
fit3<-lm(Pedal.cyclist.casualty.rate~.,data3)
summary(fit3)
...
data44<-read.csv("C:/Users/98001/Desktop/R/data-group2.csv",encoding="UTF-8")


data4<-data44[,-1]

     
fit4<-lm(Pedal.cyclist.casualty.rate~.,data4)
summary(fit4)
