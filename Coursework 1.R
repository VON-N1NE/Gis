...
#### The data are divided into two parts with a ratio of 7:3 before we build the model,
#### and use the 70% part to construct the linear regression model while using the
#### 30% part to make a comparison with the 70% part. 
